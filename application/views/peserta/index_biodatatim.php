                       ...
                       <div class="card border-left-secondary shadow h-100 py-2">
                           <div class="card-body">
                               <div class="row no-gutters align-items-center">
                                   <div class="col mr-2">
                                       <h4 class="list-group-item list-group-item-dark">DATA BIODATA TIM </h4>
                               ...
                               <br>
                                    <form method="post" action="<?php echo base_url('peserta/edit_biodatatim')?>" enctype="multipart/form-data">
                                        ...
                                        <br>
                                            <input type="text"  name="nama_hustler" style="text-transform:uppercase" class="form-control" value="<?= @$getbiodatatim['nama_hustler']; ?>">
                                            <?=form_error('nama_hustler','<small class="text-danger pl-3">','</small>');?>
                                        </div>
                                   
                                        <div class="form-group col-sm-11">
                                        <label for="textarea"><h6>2.2 Alamat Hustler : </h6></label>
                                            <textarea id="content1" rows="6" name="alamat_hustler" class="form-control"><?= @$getbiodatatim['alamat_hustler']; ?></textarea>
                                        ...
                                        <div class="form-group row col-sm-11">
                                            ...
                                            <br>
                                                <input type="number"  name="telp_hustler" class="form-control" value="<?= @$getbiodatatim['telp_hustler']; ?>">
                                            ...
                                            <br>
                                                <input type="email"  name="email_hustler" class="form-control" value="<?= @$getbiodatatim['email_hustler']; ?>">
                                        ...
                                        <label for="textarea"><h6>2.5 Tugas Hustler : </h6></label>
                                            <textarea id="content2" type="" rows="5" name="tugas_hustler" class="form-control"><?= @$getbiodatatim['tugas_hustler']; ?></textarea>
                                        ...
                                        <br>
                                            <input type="text"  name="nama_hipster" style="text-transform:uppercase" class="form-control" value="<?= @$getbiodatatim['nama_hipster']; ?>">
                                            <?=form_error('nama_hipster','<small class="text-danger pl-3">','</small>');?>
                                        </div>
                                   
                                        <div class="form-group col-sm-11">
                                        <label for="textarea"><h6>2.7 Alamat Hipster : </h6></label>
                                            <textarea id="content1" rows="6" name="alamat_hipster" class="form-control"><?= @$getbiodatatim['alamat_hipster']; ?></textarea>
                                        ...
                                        <div class="form-group row col-sm-11">
                                            ...
                                            <br>
                                                <input type="number"  name="telp_hipster" class="form-control" value="<?= @$getbiodatatim['telp_hipster']; ?>">
                                            ...
                                            <br>
                                                <input type="email"  name="email_hipster" class="form-control" value="<?= @$getbiodatatim['email_hipster']; ?>">
                                        ...
                                        <label for="textarea"><h6>2.10 Tugas Hipster : </h6></label>
                                            <textarea id="content2" type="" rows="5" name="tugas_hipster" class="form-control"><?= @$getbiodatatim['tugas_hipster']; ?></textarea>
                                        ...
                                        <br>
                                            <input type="text"  name="nama_hacker" style="text-transform:uppercase" class="form-control" value="<?= @$getbiodatatim['nama_hacker']; ?>">
                                            <?=form_error('nama_hacker','<small class="text-danger pl-3">','</small>');?>
                                        </div>
                                   
                                        <div class="form-group col-sm-11">
                                        <label for="textarea"><h6>2.12 Alamat Hacker : </h6></label>
                                            <textarea id="content1" rows="6" name="alamat_hacker" class="form-control"><?= @$getbiodatatim['alamat_hacker']; ?></textarea>
                                        ...
                                        <div class="form-group row col-sm-11">
                                            ...
                                            <br>
                                                <input type="number"  name="telp_hacker" class="form-control" value="<?= @$getbiodatatim['telp_hipster']; ?>">
                                            ...
                                            <br>
                                                <input type="email"  name="email_hacker" class="form-control" value="<?= @$getbiodatatim['email_hacker']; ?>"> 
                                        ...
                                        <label for="textarea"><h6>2.15 Tugas Hacker : </h6></label>
                                            <textarea id="content2" type="" rows="5" name="tugas_hacker" class="form-control"><?= @$getbiodatatim['tugas_hacker']; ?></textarea>
