                                            ...
                                            <br>
                                                ...
                                                <br>
                                                    <div class="col-md-11 mr-2 ml-3">
                                                        <table>
                                                            <tr>
                                                                <td width="250px"><h6 class="m-0 font-weight-bold text-dark"> Judul Proposal</h6></td>
                                                                <td width="20px"> : </td>
                                                                <td> <?= @$proposal['judul_proposal']; ?> </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="250px"> <h6 class="m-0 font-weight-bold text-dark"> Tema Proposal</h6></td>
                                                                <td width="20px"> : </td>
                                                                <td> <?= @$proposal['tema_proposal']; ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td width="250px">  <h6 class="m-0 font-weight-bold text-dark"> Nama Perusahaan Start-Up</h6></td>
                                                                <td width="20px"> : </td>
                                                                <td> <?= @$startup['nama_su']; ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td width="250px"><h6 class="m-0 font-weight-bold text-dark"> Nama Aplikasi Start-Up </td>
                                                                <td width="20px"> : </td>
                                                                <td> <?= @$reviewproduk['nama_solusi']; ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td width="250px"><h6 class="m-0 font-weight-bold text-dark"> Deskripsi Aplikasi Start-Up </h6></td>
                                                                <td width="20px"> : </td>
                                                ...
                                                <br>
                                                    <div class="col-md-11 mr-2 ml-3">
                                                        <table>
                                                            <tr>
                                                                <td width="250px"><h6 class="m-0 font-weight-bold text-dark"> Presentasi singkat</h6></td>
                                                                <td width="20px"> : </td>
                                            ...
                                            <br>
                                                <div class="col-md-11 mr-2">
                                                    ...
                                                    <table class="table table-condensed">
                                                        ...
                                                        <tbody><tr>
                                                            <td width="600px"><?php echo $adm->kriteria?></td>
                                                            <td width="100px"> <input type="number"  name="nilai[]" class="form-control col-md-12" value=""></td>
