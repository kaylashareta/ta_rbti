                       ...
                       <div class="card border-left-secondary shadow h-100 py-2">
                           <div class="card-body">
                               <div class="row no-gutters align-items-center">
                                   <div class="col mr-2">
                                       <h4 class="list-group-item list-group-item-dark">DATA BISNIS PLAN - BUSINESS MODEL CANVAS</h4>
                               ...
                               <br>
                               <form method="post" action="<?php echo base_url('peserta/edit_bisnisplan/'. @$getbisnisplan['id_proposal'])?>" enctype="multipart/form-data">
                                        <div class="form-group col-sm-11">
                                            <label><h6>5.1 Customer : </h6></label>
                                            <br>
                                            <textarea id="content22" type="" rows="5" name="cust_plan"  class="form-control"><?= @$getbisnisplan['cust_plan']; ?></textarea>
                                        ...
                                        <div class="form-group col-sm-11">
                                            ...
                                            <textarea id="content23" type="" rows="5" name="value_plan"class="form-control"><?= @$getbisnisplan['value_plan']; ?></textarea>
                                            <?=form_error('value_plan','<small class="text-danger pl-3">','</small>');?>
                                        </div>

                                        <div class="form-group col-sm-11">
                                            <label for="textarea"><h6>5.3 Channels : </h6></label><br>
                                            <textarea id="content24" type="" rows="5" name="channels_plan" class="form-control"><?= @$getbisnisplan['channels_plan']; ?></textarea>
                                            <?=form_error('channels_plan','<small class="text-danger pl-3">','</small>');?>
                                        </div>

                                        <div class="form-group col-sm-11">
                                            <label for="textarea"><h6>5.4 Relationships : </h6></label><br>
                                            <textarea id="content25" type="" rows="5" name="relation_plan" class="form-control"><?= @$getbisnisplan['relation_plan']; ?></textarea>
                                            <?=form_error('relation_plan','<small class="text-danger pl-3">','</small>');?>
                                        </div>

                                        <div class="form-group col-sm-11">
                                            <label for="textarea"><h6>5.5 Key Activities : </h6></label><br>
                                            <textarea id="content26" type="" rows="5" name="key_act_plan" class="form-control"><?= @$getbisnisplan['key_act_plan']; ?></textarea>
                                            <?=form_error('key_act_plan','<small class="text-danger pl-3">','</small>');?>
                                        </div>

                                        <div class="form-group col-sm-11">
                                            <label for="textarea"><h6>5.6 Key Resource : </h6></label><br>
                                            <textarea id="content27" type="" rows="5" name="key_res_plan"  class="form-control"><?= @$getbisnisplan['key_res_plan']; ?></textarea>
                                            <?=form_error('key_res_plan','<small class="text-danger pl-3">','</small>');?>
                                        </div>

                                        <div class="form-group col-sm-11">
                                            <label for="textarea"><h6>5.7 Key Partners : </h6></label><br>
                                            <textarea id="content28" type="" rows="5" name="key_partner_plan"  class="form-control"><?= @$getbisnisplan['key_partner_plan']; ?></textarea>
                                            <?=form_error('key_partner_plan','<small class="text-danger pl-3">','</small>');?>
                                        </div>

                                        <div class="form-group col-sm-11">
                                            <label for="textarea"><h6>5.8 Cost Structure : </h6></label><br>
                                            <textarea id="content29" type="" rows="5" name="cost_plan"  class="form-control"><?= @$getbisnisplan['cost_plan']; ?></textarea>
                                            <?=form_error('cost_plan','<small class="text-danger pl-3">','</small>');?>
                                        </div>

                                        <div class="form-group col-sm-11">
                                            <label for="textarea"><h6>5.9 Revenue Streams : </h6></label><br>
                                            <textarea id="content30"  type="" rows="5" name="revenue_plan" class="form-control"><?= @$getbisnisplan['revenue_plan']; ?></textarea>
