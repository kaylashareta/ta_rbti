                                                 ...
                                                 <table class="table table-condensed" id="dataTable">
                                                     ...
                                                     <?php 
                                                            ...
                                                            <tr>
                                                             ...
                                                             <td style="text-align:center" width="20px"> <a class="badge badge-primary fa fa-eye" target="_blank" href="<?php echo base_url('sertifikat/lihatpanitia/'.$adm->id_panitia) ?>"> Lihat Proposal </a></td>
