                    ...
                    <div class="col-xl-12 col-md-12 mb-4">
                            <div class="card border-left-secondary shadow h-100 py-2">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <?php echo anchor('panitia/tambah_panitia','<button class="btn btn-sm btn-secondary mb-3"> 
                                        ...
                                        <table class="table table-bordered table-stripped table-hover">
                                            ...
                                            <?php 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="400px"><?php echo $adm->nim_panitia?></td>
                                                                <td width="400px"><?php echo $adm->nohp_panitia?></td>
                                                                <td width="20px"><?php echo anchor('panitia/edit_panitia/'.$adm->id_panitia,'<div class="btn btn=sm btn-secondary">
